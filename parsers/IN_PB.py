...
def fetch_production(zone_key='IN-PB', session=None, target_datetime=None, logger=None) -> dict:
    ...
    data = {"zoneKey": zone_key,
            "datetime": arrow.get(timestamp_data["updateDate"], "DD-MM-YYYY HH:mm:ss",  tzinfo="Asia/Kolkata"),
            "production": {
                "hydro": 0.0,
                "coal": 0.0,
                "biomass": 0.0,
